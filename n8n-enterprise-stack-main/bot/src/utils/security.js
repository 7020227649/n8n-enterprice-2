...
// Use a fallback empty string so this module loads safely when BOT_TOKEN is
// not yet set — the startup validator in app.js will catch the missing token
// and exit before any encryption/decryption is attempted.
