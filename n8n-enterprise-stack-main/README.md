...
![Commands](https://img.shields.io/badge/Commands-50-purple)
...
| 🔧 **Workflow Tools** | 8 | Search, clone, export, import (JSON/ZIP), nodes, schedule, stop, credentials |
...
| `/import` | Upload a `.json` (single or array of workflows) or `.zip` to import workflows |
